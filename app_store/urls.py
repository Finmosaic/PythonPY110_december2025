...
from .views import product_view_json, shop_view, product_page_view, coupon_check_view, cart_remove_view
...
urlpatterns = [
    ...
    path('cart/remove/<str:id_product>', cart_remove_view, name="remove_view"),
